...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_65_ansi(
        ...
        KC_CAPS,    RGB_SPI,    RGB_SPD,    RGB_M_P,    RGB_M_B,    RGB_M_R,    RGB_M_SW,   RGB_M_SN,   RGB_M_K,    RGB_M_X,    RGB_M_G,    _______,                EEP_RST,    KC_PGDN, 
        KC_LSFT,                BL_TOGG,    BL_STEP,    BL_ON,      BL_OFF,     BL_INC,     BL_DEC,     BL_BRTG,    _______,    _______,    _______,    _______,    KC_VOLU,    KC_END, 
        _______,    _______,    _______,                               _______,                                     _______,    _______,    KC_MUTE,    KC_MPRV,    KC_VOLD,    KC_MNXT
    )
};